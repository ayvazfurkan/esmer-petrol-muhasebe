          ...
          datasets: [
            {
              ...
              backgroundColor: ['rgba(48,63,159,0.65)', 'rgba(255,176,0,0.65)', 'rgba(0,121,107,0.65)', 'rgba(237,66,144,0.65)', 'rgba(75,192,192,0.65)', 'rgba(12,156,235,0.66)',
                'rgba(48,63,159,0.65)', 'rgba(255,176,0,0.65)', 'rgba(0,121,107,0.65)', 'rgba(237,66,144,0.65)', 'rgba(75,192,192,0.65)', 'rgba(12,156,235,0.66)', 'rgba(48,63,159,0.65)', 'rgba(255,176,0,0.65)', 'rgba(0,121,107,0.65)', 'rgba(237,66,144,0.65)', 'rgba(75,192,192,0.65)', 'rgba(12,156,235,0.66)'],
              data: data,
              barPercentage: 0.15
            }
          ]
