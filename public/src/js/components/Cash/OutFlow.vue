<template>
    <div class="row py-5">
        ...
        <div class="col-12 pb-3 pt-2">
            <h6 class="text-transparent mb-0">Kasa İşlemleri \ Kasa Tediye</h6>
        </div>
        <div class="col-md-12">
            <div class="card p-4">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12 mb-3">
                        ...
                        <div class="input-group" :class="invalidField(exception.customerId)">
                            <multiselect
                                    v-model="outFlowForm.customerId"
                                    placeholder=""
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group" :class="invalidField(exception.currencyId)">
                            <multiselect
                                    v-model="outFlowForm.currencyId"
                                    placeholder=""
                                    :options="currencies"
                                    selectLabel="Seçmek için Enter"
                                    deselectLabel="İptal için Enter"
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group" :class="invalidField(exception.description)">
                            <textarea class="form-control" v-model="outFlowForm.description" rows="3"></textarea>
                        </div>
        ...
        <div class="col-12 my-3 text-right">
            ...
            <button class="btn btn-sm btn-primary" @click="save"
                    :class="{'disabled': !outFlowForm.creatorId || !outFlowForm.currencyId || !outFlowForm.amount || waitingResponse || success}"
                    :disabled="!outFlowForm.creatorId || !outFlowForm.currencyId || !outFlowForm.amount || waitingResponse || success">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                outFlowForm: {
                    currencyId: {'id': 1, 'name': 'Türk Lirası'}
                },
                customerList: [],
                currencies: [],
                exception: {},
        ...
        mounted() {
            this.outFlowForm.creatorId = this.getSession.userDetails.id
            this.outFlowForm.branchId = this.getSession.userDetails.branchId
        ...
        methods: {
            save() {
                ...
                let result = ipcRenderer.sendSync("/cash/outFlow", this.outFlowForm)
