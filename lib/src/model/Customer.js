...
export default class Customer {
  ...
  getSummary (data, rowCount) {
    ...
    const query = this.db('customerMoneyFlow as csmf').select('csmf.id', 'csmf.amount', 'csmf.description', 'csmf.creatorId', 'csmf.createDate', 'user.name', 'user.username').leftJoin('user', 'csmf.creatorId', 'user.id')
    if (data.customerId) {
